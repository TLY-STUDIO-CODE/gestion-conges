...
<template>
    <GuestLayout>
        ...
        <div class="mb-6">
            <h2 class="text-xl font-bold text-gray-900 tracking-tight">Nouveau mot de passe</h2>
            <p class="text-xs text-gray-500 mt-1">Veuillez définir votre nouveau mot de passe sécurisé.</p>
        </div>
